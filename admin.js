...
// Per-account keys: each logged-in user has their own doctors & specialties list
function _userScope() {
...
function MAJORS_KEY()  { return 'clinic_majors_v1::'  + _userScope(); }
const DEFAULT_ADMIN = {
